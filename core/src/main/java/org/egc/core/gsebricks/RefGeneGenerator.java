 ...
 *   
 *   reads the properties file org.egc.core.gseutils.properties.gene_names which is formatted as 
...
public class RefGeneGenerator<X extends Region> 
    ...
    public void setGenome(Genome g, String t) { 
        genome = g;
        ResourceBundle res = ResourceBundle.getBundle("org.egc.core.gseutils.properties.gene_names");
