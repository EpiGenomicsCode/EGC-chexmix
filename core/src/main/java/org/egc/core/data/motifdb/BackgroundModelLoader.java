...
java org.egc.core.data.motifdb.BackgroundModelLoader --species "$HS;hg19" --bgname 'whole genome zero order' --bgtype FREQUENCY --bgfile hg19.zero
where hg19.zero is 
.2 A
.3 C
.2 T
...
public class BackgroundModelLoader {
   ...
   *
   * Usage:
   * java org.egc.core.data.motifdb.BackgroundModelLoader --genome "Mus musculus;mm8" --bgname "whole genome" --bgtype MARKOV --bgfile foo.back
   */
