 ...
 */
package org.egc.core.data.io.parsing;
 ...
 */
public class FASTAStream implements Iterator<Pair<String,String>>, org.egc.core.gseutils.Closeable {
    ...
    /* (non-Javadoc)
     * @see org.egc.core.gse.hyperdrive.utils.Stream#hasNext()
     */
    ...
    /* (non-Javadoc)
     * @see org.egc.core.gse.hyperdrive.utils.Stream#next()
     */
    ...
    /* (non-Javadoc)
     * @see org.egc.core.gse.hyperdrive.utils.Stream#getDescriptor()
     */
    ...
    /* (non-Javadoc)
     * @see org.egc.core.gseutils.Closeable#close()
     */
    public void close() {
        if (isClosed()) {return;}
        try { 
    ...
    /* (non-Javadoc)
     * @see org.egc.core.gseutils.Closeable#isClosed()
     */
