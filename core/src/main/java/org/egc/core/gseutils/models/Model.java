...
import org.egc.core.gseutils.json.JSONArray;
import org.egc.core.gseutils.json.JSONException;
import org.egc.core.gseutils.json.JSONObject;
	...
	public JSONObject asJSON() { 
		...
		for(int i = 0; i < fs.length; i++) {
			...
			if(!isStatic) { 
				...
				} catch (org.egc.core.gseutils.json.JSONException e) {
